                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('app.eidt') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <form action="{{ url('product/update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-md-6 offset-md-3">
                    <label for="img" id="label-img">
                        <img style="cursor: pointer;" class="preview" src="{{ url('uploads/items/'.$item->img) }}" title="Choose image" />
                    </label>
            ...
            <div class="row">
                <div class="form-group col-md-6 offset-md-3">
                    ...
                    <input type="text" name="name" id="name" value="{{ $item->name }}" class="form-control" placeholder="Item Name" required>
                    @if ($errors->has('name'))
                    <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group col-md-6 offset-md-3">
                    ...
                    <textarea rows="5" name="description" id="description" class="form-control" placeholder="Item description" required>{{ $item->description }}</textarea>
