    ...
    <div class="container" style="margin-top: 60px">
        ...
        <form action="{{ route('admin.team.edit', ['employee'=>$employee]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input type="text" name="name[en]" value="{{ old('name.en')??$employee->name['en'] }}" class="form-control" required  id="nameen" placeholder="employee Name In English">
                    @error('name.en')
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input type="text" name="name[ar]" value="{{ old('name.ar')??$employee->name['ar'] }}" class="form-control" required  id="namear" placeholder="employee Name In Arabic">
                    @error('name.ar')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <textarea name="details[en]" required placeholder="Details about Employee In English" class="form-control">{{ old('details.en')??$employee->details['en'] }}</textarea>
                    @error('details.en')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <textarea name="details[ar]" required placeholder="Details about Employee In Arabic" class="form-control">{{ old('details.ar')??$employee->details['ar'] }}</textarea>
                    @error('details.ar')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
