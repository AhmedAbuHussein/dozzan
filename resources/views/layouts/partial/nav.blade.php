                    ...
                    <nav class="navbar navbar-default" id="mainNav">
                        <div class="navbar-header">
                            ...
                            <div class="logo">
                                <a class="navbar-brand js-scroll-trigger logo-header" href="{{ route('home') }}">
                                    <img src="{{ url($setting->where('key', 'logo')->first()->value_lang) }}" alt="" style="width:125px;">
                                </a>
                            </div>
                        </div>
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="active"><a href="#banner">{{ __('file.Home') }}</a></li>
                                ...
                                @if(app()->getLocale() == 'en')
                                <li><a href="{{ route('change.lang', ['lang'=>'ar']) }}">عربي</a></li>
                                @else
                                <li><a href="{{ route('change.lang', ['lang'=>'en']) }}">EN</a></li>
